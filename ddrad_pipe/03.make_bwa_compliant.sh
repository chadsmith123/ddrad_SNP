...
# Chad Smith
#
# Replaces _2 in Illumina read 2 fastq.gz header to _1 to match read 1. If the fastq header in read2 is 
# different from read1 BWA will not work.
# 
# Script creates a directory bwa in $LIBS for the BWA compliant reads, and creates soft links in this 
